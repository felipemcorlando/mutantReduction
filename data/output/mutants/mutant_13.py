...
class FlightBookingFSM:
    ...
    def apply_discount(self):
        ...
        if not (self.booking_fee > 50 and self.booking_fee <= 100):
            discount_rate = 0.1
            self.booking_fee = (self.booking_fee - self.booking_fee *
                discount_rate)
        if not self.booking_fee > 100:
            discount_rate = 0.2
            self.booking_fee = (self.booking_fee - self.booking_fee *
                discount_rate)
    ...
    def add_tax(self):
        ...
        tax_rate = 0.2
        self.booking_fee = self.booking_fee + self.booking_fee * tax_rate
